...
string name_of_output_results = "outputResults" +kmer_length_str + "_withKmers_withUIDS.txt";


//pathes
string path_to_the_program_directory = "/export1/project/hondius/newKrakenResearch/";
string path_to_the_genomes_database = "/export1/project/hondius/newKrakenResearch/databases/kmerDatabase31/";
...
string path_to_the_specific_nodes = "/export1/project/hondius/newKrakenResearch/databases/uids.txt";
